...
<div class="body-pagamento">
   ...
   <div class="alert alert-warning" role="alert">
    ...
    <div class="copia-cola">
        ...
        <div id="btn-copia" onclick="copiaQr()"><ion-icon name="documents-outline"></ion-icon></div>
    </div>
   <?php endif; ?>
</div>
</div>
 ...
 Detalhes da sua compra  </h6>
                                        ...
                                        <div class="infos">
                                            ...
                                            <p><b>Total: </b> <?php echo e('R$ '.number_format($venda->valueAll, 2, ',', '.')); ?>  </p>
                                            <hr>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projetos\laravel\sorteio\resources\views/finalizar.blade.php ENDPATH**/ ?>