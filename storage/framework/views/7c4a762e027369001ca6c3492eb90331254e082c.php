        ...
        <div class="corpo-menu">
            <div class="lista-menu">
                <ul>
                    ...
                    <a href="/contato"><li><ion-icon class="icon" name="send"></ion-icon> Contato</li></a>
                    <?php if(auth()->guard()->check()): ?>
...
<?php /**PATH C:\projetos\laravel\sorteio\resources\views/layouts/user.blade.php ENDPATH**/ ?>