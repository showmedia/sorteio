...
@if($sorteio->tipo == 1)
               <div class="desconto bg-danger info-pisca" id="info-pisca">Promoção: Pague apenas 30 centavos por cota na compra a partir de 50 <span id="desconto"> - *Desconto aplicado</span></div>
@endif
